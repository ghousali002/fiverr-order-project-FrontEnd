      ...
      <div className="col-sm-12" style={{ marginTop: "6em" }}>
        <div className="box">
          ...
          <ul>
            <li>
              <h5>
                <span id="online_users">121</span> <br />
                <small>Online Users</small>
              </h5>
            </li>
            <li>
              <h5>
                <span id="total_running_floods">9/15</span> <br />
                <small>Running Attacks</small>
              </h5>
            </li>
            <li>
              <h5>
                <span id="todays_floods">1,564</span> <br />
                <small>Attacks Today</small>
              </h5>
            </li>
            <li>
              <h5>
                <span id="your_attacks_today">0/50</span> <br />
                <small>Your Attacks Today</small>
              </h5>
            </li>
            <li>
              <h5>
                <span id="total_floods">585,894</span>
                <br />
