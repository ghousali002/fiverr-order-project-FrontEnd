                        ...
                        <div className="modal-content">
                          <div className="modal-header">
                            <h5
                              ...
                              id="loadPreset"
                            >
                              <i className="fa fa-angle-right"></i> Load a
                              preset
                            </h5>
                            <button
                              type="button"
                                ...
                                <form method="post">
                                  <div className="form-group">
                                    <label style={{ marginBottom: 15 }}>
                                      <i className="fa fa-key"></i> IMPORT
                                      PRESET via Key
                                    </label>
                                    <input
                  ...
                  <form>
                    ...
                    <div className="form-group row" id="methodL4F">
                      <div className="col-sm-6">
                        ...
                        <br />
                        <select className="form-control" id="methodL4" value={method}
      ...
      <div className="modal-content bg-dark">
        ...
        >
          <div className="modal-dialog text-white" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title text-white" id="scheduleAttack">
              ...
              <div className="modal-body">
                <div className="form-group row">
                  <div className="col-6">
                    ...
                    <input type="date" className="form-control" id="scheduleDateL4" value="2023-11-18" />
                  </div>
                  <div className="col-6">
                    <label style={{marginBottom:7}}>HOUR</label>
                    <input type="time" className="form-control" id="scheduleHourL4" value="20:01" />
                  </div>
                </div>
                <div className="form-group">
                  <button
                  style={{marginBottom:15,marginTop:18,width:463}}
                    type="button"
                    className="btn btn-primary btn-block"
                    onClick={() => {
                      closeScheduleModal();
                  ...
                  <div className="col-10 mx-auto">
                    <div className="table-responsive text-center">
                      <table className="table table-sm text-white">
                        <thead>
                          <tr>
                            <th style={{ padding: '0px 0px' }}>HOST</th>
                            <th style={{ padding: '0px 0px' }}>DATE</th>
                            <th style={{ padding: '0px 0px' }}>HOUR</th>
                            <th style={{ padding: '0px 0px' }}>ACTION</th>
                          </tr>
                        </thead>
          ...
          <div className="row">
            <div className="col-lg-12">
              ...
              <tr key={index}>
                ...
                <td>
                     <div className="btn-group btn-block" role="group" aria-label="Attack">
                    <button type="button" className="btn btn-xs btn-danger" onClick={() => stopAttack(index)} >
